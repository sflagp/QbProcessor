...
namespace QbModels.QBOProcessor.TEST
{
    ...
    public class TestPurchaseModels
    {
        ...
        public async Task Step_1_QBOPurchaseQueryTest()
        {
            ...
            HttpResponseMessage getRs = await qboe.QBOGet($"/v3/company/{qboe.ClientInfo.RealmId}/query?query=select * from Purchase");
        ...
        public async Task Step_3_QBOPurchaseModTest()
        {
            ...
            Assert.AreNotEqual(purchase.MetaData.LastUpdatedTime, modRs.Purchases[0].MetaData.LastUpdatedTime);
            #endregion
        }
